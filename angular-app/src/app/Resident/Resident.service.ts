...
export class ResidentService {
    ...
    constructor(private residentService: DataService<Resident>,  private carbonService: DataService<Carbon>,private coinsService: DataService<Coins>, private energyService: DataService<Energy>, private cashService: DataService<Cash>) {
    };
    ...
    public getAllCarbon(): Observable<Carbon[]> {
      return this.carbonService.getAll(this.CARBON);
  }
  ...
  public addCarbon(itemToAdd: any): Observable<Carbon> {
    return this.carbonService.add(this.CARBON, itemToAdd);
  }

  public updateCarbon(id: any, itemToUpdate: any): Observable<Carbon> {
    return this.carbonService.update(this.CARBON, id, itemToUpdate);
  }

  public deleteCarbon(id: any): Observable<Carbon> {
    return this.carbonService.delete(this.CARBON, id);
  }
